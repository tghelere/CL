    ...
    <div>
        ...
        <div class="p-3 mb-3 bg-white rounded box-shadow">
            ...
            <b-row>
                ...
                >
                    <template slot="actions" slot-scope="row">
                        <b-button 
                            size="sm"
                            v-b-modal.modalFormBanner 
                            @click.prevent="modalFormBanner = Object.assign({}, row.item)" 
            ...
            <b-modal 
                ...
                <b-form 
                    @submit.prevent="modalFormBanner.id > 0 ? putBanner(modalFormBanner) : postBanner(modalFormBanner)"
                    @input="changeButton" 
        ...
        methods: {
            ...
            putBanner(form) {
                ...
                axios.post(action, fd).then(response => {
                        this.$root.$emit('bv::hide::modal', 'modalFormBanner')
                        this.getBanner()
                        this.isLoading = false
