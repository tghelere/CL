<template>
    <div>
        ...
        <b-container fluid>
            ...
            <b-modal id="openMessage" size="lg" ok-only hide-footer :title="selectedMessage.type + ' de ' + selectedMessage.name">
                <b-row>
                    <b-col md="4">
                        <p><span class="font-weight-bold">Id:</span> <span class="font-italic">{{selectedMessage.id}}</span></p>
                    </b-col>
                    <b-col md="4">
                        <p><span class="font-weight-bold">Tipo:</span> <span class="font-italic">{{selectedMessage.type}}</span></p>
                    </b-col>
                    <b-col md="4">
